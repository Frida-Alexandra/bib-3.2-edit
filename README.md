...
Для отображения списка создайте компонент `ListingPage`, который принимает следующие атрибуты:
...
Необходимо отобразить данные списка предложений, используя компонент `ListingPage`.
